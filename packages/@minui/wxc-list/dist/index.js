'use strict';
// var countShow = wx.getStorageSync("count");
var titleShow = new Array(wx.getStorageSync("titleShow"));
// console.log("info_titlwShow=" + titleShow);
Object.defineProperty(exports, "__esModule", {
  value: true
});
// Object.defineProperty(titleShow, '_title', {
//   //调用get方法读取属性
//   get: function () {
//     return this._title;
//   },
...
exports.default = Component({
  ...
  properties: {
    ...
    src: {
      type: String,
      value: '../../../../assets/watch.png' // 标题左侧icon图片链接
    },
    dot: {
      type: Boolean,
